<div class="row">
  <div class="col-md-12">
    <div class="box">
      <h1 style="text-align: center;">Company Update Form</h1>
          ...
          <form id="formone" class="form-group" method="post" enctype="multipart/form-data">
            <div class="row">
              <div class="col-sm-12 col-md-4 col-lg-4">
                <label>Company</label>
                <input type="text" class="form-control" placeholder="Enter Company Name" name="CompanyName" value="<?php echo $key->company;?>">
                <span style="color: red;"><?= form_error('CompanyName');?></span>
              </div>
