        ...
        <div class="box-body" style="overflow-x:auto;">
          ...
          <tbody>
              <?php if(!empty($pendingdetails)) { foreach($pendingdetails as $key) {?>
                <tr>
                  <td><a href="pendingupdate?quotation_code=<?php echo $key->quotation_code;?>"><i class="fa fa-pencil-square-o"></i>Edit</a><a href="quotation_delete?quotation_code=<?php echo $key->quotation_code;?>"><i class="fa fa fa-trash" style="margin:3px;"></i>Delete</a></td>
